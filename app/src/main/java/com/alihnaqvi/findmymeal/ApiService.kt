...
interface ApiService {
    ...
    @GET("json")
    fun fetchRestaurants(@Query("key") key: String,
                         @Query("location") location: String,
                         @Query("rankby") rankBy: String,
                         @Query("keyword") keyword: String,
                         @Query("type") type: String): Observable<Models.RestaurantsResult>

    @GET("json")
    fun fetchGeocodedAddress(@Query("key") key: String,
                             @Query("place_id") placeId: String): Observable<Models.GeocodingResult>
